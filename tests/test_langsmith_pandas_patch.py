...
def test_non_pandas_objects_pass_through():
    ...
    # Plain object — langsmith's original _serialize_json falls to
    # _simple_default which returns str() of the object. We just verify
    # the patch delegates correctly and doesn't crash on non-DataFrame
    # input.
    class PlainObj:
        def __repr__(self):
            return "PlainObj()"
